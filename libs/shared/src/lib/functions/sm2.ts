 ...
 * @param previousInterval A number generated by the algorithm, indicates the number of days to wait between reviews. Equal to 0 if field left empty, indicating this is the first review day
 *
 * @remarks Adapted from https://github.com/thyagoluciano/sm2
 */
export function sm2(quality: number, previousRepetitions?: number, previousEaseFactor?: number, previousInterval?: number): {
  interval: number,
    repetitions: number,
    easeFactor: number
} {
