...
import { MediaException } from "../shared/exception/exceptions/variants/media.exception";
...
export class MediaController {
  ...
  async getSetFile(
    ...
    if (!file) throw new MediaException.MediaNotFound();
  ...
  async setMyAvatar(
    ...
    if (!file) throw new MediaException.MediaNotProvided();
